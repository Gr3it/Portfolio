...
import ExperimentBubble from "Components/ExperimentBubble";
        ...
        <div className="container-width">
          ...
          <section className="project" id="project">
            ...
            <div className="project-container">
              ...
              <ProjectCard
                title="Flynet"
                tags="HTML, CSS, Javascript, MySQL, Servlet, JSP"
                date="April - May 2021"
                url="flynet"
              ...
              <div className="about-first-section-container">
                <div className="about-text">
                  ...
                  <div className="about-paragraph">
                    ...
                    elit. Mollitia, incidunt? Et incidunt repudiandae neque
                    blanditiis impedit odio perspiciatis illo pariatur est sint,
                    sapiente, dolorem odit accusamus.
                  </div>
                </div>
